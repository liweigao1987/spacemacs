...
you should place your code here."
  ...
  (add-to-list 'load-path "/home/liweigao/.emacs.d/private/color-rg/")
  (require 'color-rg)
  (spacemacs/set-leader-keys "/" 'color-rg-search-input-in-project)
  )
