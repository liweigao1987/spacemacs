...
before packages are loaded."
  ...
  (setq lsp-java-server-install-dir "/home/liweigao/big/work/project/spacemacs/download/jdt-language-server/jdt-language-server-0.68.0-202101202016/")
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(projectile-globally-ignored-directories
     '(".idea"
       ...
       ".repo"
       ".kiro"))
   '(projectile-globally-ignored-file-suffixes '(".i" ".d" ".s" ".su" ".o"))
  ...
  (custom-set-faces
   ...
   '(line-number-current-line
     ((t (:inherit line-number :background "#212026" :foreground "lawn green")))))
  )
